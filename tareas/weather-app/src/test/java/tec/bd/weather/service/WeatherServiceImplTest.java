...
public class WeatherServiceImplTest {
    ...
    public void GivenExistingForecast_WhenCreateNewForecast_ThenServiceException() {
        ...
        given(forecastRepository.findById(anyInt())).willReturn(Optional.of(new Forecast(5, "Costa Rica", "Limon", "33122", new Date(), 23.0F)));
    ...
    @Test
    public void GivenValidForecast_WhenForecats_DoesntExist_ThenNewTemperature() {
    ...
    @Test
    public void GivenValidForecast_WhenForecatsHaveInvalidValues () {
    ...
    @Test
    public void GivenValidForecast_WhenDeleteForecast() {
