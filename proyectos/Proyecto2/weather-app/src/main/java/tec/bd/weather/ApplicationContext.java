...
public class ApplicationContext {
    ...
    private Repository<beforeForecast, Integer> inMemoryForecastBeforeRepository;
    private Repository<beforeForecast, Integer> sqlForecastBeforeRepository;
    ...
    public ApplicationContext() {
        ...
        initInMemoryForecastBeforeRepository();
        initSQLForecastBeforeRepository();
    ...
    private void initInMemoryForecastBeforeRepository() {
        this.inMemoryForecastBeforeRepository = new InMemoryForecastBeforeRepository();
    }

    private void initSQLForecastBeforeRepository() {
        this.sqlForecastBeforeRepository = new ForecastBeforeRepository(this.sqliteDataSource);
    }

    private void initWeatherService() {
        this.weatherService = new WeatherServiceImpl(this.sqlForecastBeforeRepository);
    }

    public Repository<beforeForecast, Integer> getInMemoryForecastBeforeRepository() {
        return this.inMemoryForecastBeforeRepository;
    }

    public Repository<beforeForecast, Integer> getSqlForecastBeforeRepository() {
        return this.sqlForecastBeforeRepository;
    }
